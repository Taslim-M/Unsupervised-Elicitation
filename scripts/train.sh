...
# Default to Democrat if no argument is provided
PARTY=${1:-Democrat}

# You can also change the model via the second argument if needed
MODEL=${2:-llama70b-gpu0}

# Default seed
SEED=${3:-27565976}

echo "Starting training for Party: $PARTY with Model: $MODEL Seed: $SEED"
